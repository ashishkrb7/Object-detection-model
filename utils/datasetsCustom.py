...
def LoadImages(path, img_size=640):
    # img0 = cv2.imread(path)  # BGR
    # img0=np.array(Image.fromarray(np.roll(np.array(np.array(Image.open(path))),1,axis=-1))) #RGB
    img0=cv2.cvtColor(np.array(Image.open(path)), cv2.COLOR_BGR2RGB)
    # img0=readb64(path)
    # Padded resize
