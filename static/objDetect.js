...
const scoreThreshold = s.getAttribute("data-scoreThreshold") || 0.7;
const apiServer = s.getAttribute("data-apiServer") || window.location.origin + '/visualbot/router'; //the full TensorFlow Object Detection API server url
...
function drawBoxes(object) {
    ...
    // console.log("hi",typeof objects);
   //  console.log("hi",objects[1].class_name);
    ...
    objects.filter(object => object.class_name).forEach(object => {
         ...
         // console.log("hi",object.class_name);

       //  $("#obj_name").val(object.class_name);


if(object.class_name !=  $("#obj_name").text() )
{

         $("#obj_name").text(object.class_name);
         const ut = new SpeechSynthesisUtterance(object.class_name);
         speechSynthesis.speak(ut);


         $("#obj_des").text(object.name);

        
         const ut_des = new SpeechSynthesisUtterance(object.name);
         speechSynthesis.speak(ut_des);
